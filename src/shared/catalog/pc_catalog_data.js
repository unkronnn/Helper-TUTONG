...
const __pc_catalog_games = {
  ...
  apex_legends: {
    ...
    cheats      : [
      ...
      {
        id          : 'eon_apex',
        name        : 'EON | APEX EXTERNAL',
        emoji       : '<:eon:1480503421051080704>',
        description: 'External & Undetected Apex Legends cheat from EON group',
        features    : [
          '**AIMBOT**',
          '• Enable Aimbot (Kernel / Memory)',
          '• Custom Keybind & Save Target',
          '• Target Bone (Head / Neck / Chest & More)',
          '• Ignore Team & Invisible',
          '• Smooth & Accuracy Rate',
          '• Target Priority (Crosshair / Distance)',
          '• Bezier Curve & Humanization',
          '• Recoil Control & Micro Jitter',
          '• Hand Tremor',
          '• Smooth Interpolation [Linear / Bezier]',
          '• FOV Circle & Crosshair & Target Line',
          '',
          '**VISUALS**',
          '• Box (Normal / Cornered / Rounded / Bounding)',
          '• Skeleton & Thickness',
          ...
          '• Weapon & Ammo',
          '• Team ID & Level',
          '• Chinese Hat & Visible Check',
          '• Visible & Nearby Count',
          '• Spectators List',
          '• OOF Arrows',
          '• Outlined ESP',
          '• Text Background & Ignore Team',
          '',
          '**RADAR**',
          '• Enable Radar & Radar Type [Rectangle / Circle]',
          '• Position (X/Y)',
          '• Size & Range',
          '• Show Distance',
          '',
          ...
          '• Weapon & Item',
          '• Ammo & Chests',
          '• Rarity Filters (Heirloom / Legendary / Epic / Rare / Common)',
          '• Render Distance',
          '',
          '**COLORS & SETTINGS**',
          '• VSync',
          '• Menu Accent Color',
          '• Performance Mode & VSync',
          '',
          '**CONFIG**',
          '• Save/Load Configuration',
          '• Multiple Config Slots',
          '• Custom Keybinds [20+ Options]'
        ],
        system      : {
          processors: 'Intel & AMD',
          os        : 'Windows 10-11 [1607-25H2]',
          graphics  : 'Nvidia & AMD',
          disk      : 'Not specified',
          bios      : 'Not specified',
          type      : 'External'
        ...
        additional  : [
          'Fully Undetected From EAC',
          'External & Undetected'
        ],
        prices      : [
          { duration: '1 Day',  price_idr: 'Rp 70.000',   price_usd: '$3.99'  },
          { duration: '3 Day',  price_idr: 'Rp 120.000',  price_usd: '$6.99'  },
          { duration: '7 Day',  price_idr: 'Rp 250.000',  price_usd: '$14.99' },
          { duration: '30 Day', price_idr: 'Rp 550.000',  price_usd: '$29.99' }
        ]
      }
    ]
  },
