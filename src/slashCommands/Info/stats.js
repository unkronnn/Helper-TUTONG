...
module.exports = {
  data: new SlashCommandBuilder()
    .setName('stats')
    .setDescription('Tampilkan informasi detail tentang bot'),
  ...
  run: async (client, interaction) => {
    ...
    const buyerCount = config.buyerRoleId 
      ? guild.members.cache.filter(m => m.roles.cache.has(config.buyerRoleId)).size 
      : 0;
